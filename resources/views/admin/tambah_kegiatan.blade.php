...
@section('content')
    ...
    <div class="detail-kegiatan-edit">
        ...
        <div class="container" style="background-color: white" >
            <br>
            <center><img src="{{ asset('img/tambahposter.png') }}" alt="/poster"></center>
            <br>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h4>:</h4>
                        <input type="text" class="form-control" id="inputNamaKegiatan"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Caption" id="Caption"
                            style="height: 100px" name="benefit"></input>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h4>:</h4>
                        <input type="file" class="form-control" placeholder="Masukkan Caption" id="Caption"
                            style="height: 100px" name="benefit"></input>
                    </div>
                </div>
                <br>
