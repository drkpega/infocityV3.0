    ...
    <div class="all-kegiatan">
                ...
                <div class="carousel-inner">
                    ...
                    @foreach ($lomba as $l)
                        <div class="carousel-item">
                            <a href="/postingan/detail/{{ $l->id }}"><img
                                    src="/images/kegiatan/{{ $l->poster_postingan }}" class="d-block w-100"
        ...
        <div class="kegiatan">
            ...
            <div id="carouselExampleControls2" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="/admin/beasiswa"><img src="/images/activebeasiswa.png" class="d-block w-100"
                                alt="/beasiswa"></a>
                    </div>
                    @foreach ($beasiswa as $b)
                        <div class="carousel-item">
                            <a href="/postingan/detail/{{ $b->id }}"><img
                                    src="images/kegiatan/{{ $b->poster_postingan }}" class="d-block w-100"
        ...
        <div class="kegiatan">
            ...
            <div id="carouselExampleControls3" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="/admin/volunteer"><img src="/images/activevolunteer.png" class="d-block w-100"
                                alt="/volunteer"></a>
                    </div>
                    @foreach ($volunteer as $v)
                        <div class="carousel-item">
                            <a href="/postingan/detail/{{ $v->id }}"><img
                                    src="/images/kegiatan/{{ $v->poster_postingan }}" class="d-block w-100"
        ...
        <div class="kegiatan">
            ...
            <div id="carouselExampleControls4" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    @foreach ($event as $e)
                        <div class="carousel-item">
                            <a href="/postingan/detail/{{ $e->id }}"><img
                                    src="/images/kegiatan/{{ $e->poster_postingan }}" class="d-block w-100"
